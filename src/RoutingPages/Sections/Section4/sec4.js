  ...
  return (
    ...
    '>
      ...
      '>
        ...
        <img src="saiss.jpeg" alt="" className='w-[15rem] h-[18rem]  lg:w-[13rem] lg:h-[20rem] hover:opacity-90'/>
        <img src="hakimi.jpeg" alt="" className='w-[15rem] h-[18rem]  lg:w-[13rem] lg:h-[20rem] hover:opacity-90'/>
        <img src="bono.jpeg" alt="" className='w-[15rem] h-[18rem]  lg:w-[13rem] lg:h-[20rem] hover:opacity-90'/>
        <img src="ziach.jpeg" alt="" className='w-[15rem] h-[18rem] lg:w-[13rem] lg:h-[20rem] hover:opacity-90'/>
        <img src="nsiri.jpeg" alt="" className='w-[15rem] h-[18rem] lg:w-[13rem] lg:h-[20rem] hover:opacity-90'/>
      </div>
...
// top-[7rem] lg:top-[29rem]  main:mt-[3rem] md:relative md:top-[-7rem]